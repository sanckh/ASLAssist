                ...
                <ScrollView style={styles.scrollview}>
                    <View style = {{flexDirection: 'row', marginTop: 10}}>
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter A is signed by hand in a fist, with the thumb sticking up to the side of the fist.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter B is signed by palm facing out and all 4 fingers standing straight and kept together.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter C is signed by curving your hand  where the top 4 fingers held together make up the top curve.</Text>
                        </View>
                    </View>
                    ...
                    <View  style = {{flexDirection: 'row', marginTop: 10}}>
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter D is signed by holding up your hand, curving your middle, ring, and pinkie fingers together.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter E is signed by holding palm facing out, with your top 4 fingers all touching each other and tightly curved in.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter F is signed by holding palm facing out, with your index finger and thumb touching. Make sure to form a circle with your thumb and index finger touching.</Text>
                        </View>
                    </View>
                    ...
                    <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter G is signed by holding a fist, with knuckles lined up vertically. Keep your middle, ring, and pinkie fingers curled in.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter H is signed by holding out your palm facing in, with your index and middle fingers held out together. The rest of the fingers and thumb are curled in.</Text>
                        </View>
                    ...
                    <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter J is signed by making a 'J' in the air with your pinkie finger, starting from the top of the 'J' stem down to form the bottom part of the letter.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter K is signed by holding up your palm facing out, index and middle fingers sticking up like the letter 'V' while your thumb is tucked</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter L is signed by holding up your dominant hand, palm facing out, with your thumb and index finger sticking out at a right angle to each other.</Text>
                        </View>
                    </View>
                    ...
                    <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter M is signed by holding up your palm facing out, with all your fingers curled into your palm. Then tuck your thumb between your ring and pinkie fingers.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter N is signed by holding up your palm facing out, with all your fingers curled into your palm. Then tuck your thumb between your middle and ring fingers. </Text>
                        </View>
                    ...
                    <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter P is signed like K. Hold down your dominant hand, palm facing in, with your index and middle fingers sticking out like an inverted letter 'V'.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter Q is signed by holding palm facing in. Keep your middle, ring, and pinkie fingers curled in.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter R is signed by holding palm facing out, with your index and middle fingers intertwined like vines.</Text>
                        </View>
                    </View>
                    ...
                    <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter S is signed by holding hand a fist, palm facing out. Make sure your thumb is tucked in front of your fingers.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter T is signed by holding hand into a fist, palm facing out, and your thumb tucked in between your index and middle fingers.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter U is signed by holding hand in a fist, facing outward, with the index and middle fingers sticking up while held together.</Text>
                        </View>
                    </View>
                    ...
                    <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter V is signed by holding hand in a fist, facing outward, with the index and middle fingers sticking out and spread apart.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter W is signed by holding hand in a fist, palm facing out, with your index, middle, and ring fingers sticking out.</Text>
                        </View>
                    ...
                    <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter Y is signed by holding hand, palm facing out, with your thumb and pinkie finger sticking out and the rest of your fingers curled in.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {[styles.text, {color: colors.text}]}>The letter Z is signed by holding up the index finger palm facing out drawn into a fist, and tracing the letter 'Z' with your index in the air.</Text>              
                        </View>
                    </View>
                </ScrollView>
            </View>
