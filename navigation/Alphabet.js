                ...
                <ScrollView style={styles.scrollview}>
                    <View style = {{flexDirection: 'row', marginTop: 10}}>
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter A is signed by holding up your dominant hand in a fist, facing outward, with the thumb sticking up to the side of the fist.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter B is signed by holding up your dominant hand open, with palm facing out and all 4 fingers standing straight and kept together, while tucking your thumb into your palm.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter C is signed by curving your open, dominant hand just like the letter 'C', where the top 4 fingers held together make up the top curve, and the thumb makes up the bottom curve.</Text>
                        </View>
                    </View>
                    ...
                    <View  style = {{flexDirection: 'row', marginTop: 10}}>
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter D is signed by holding up your dominant hand, curving your middle, ring, and pinkie fingers together and touching them to your thumb, while only your index finger is standing upright.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter E is signed by holding up your dominant hand, palm facing out, with your top 4 fingers all touching each other and tightly curved in, while your thumb is also curved and tightly tucked into your palm, touching the tips of the fingers above. This looks just like the small letter 'e'.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text  style = {styles.text}>The letter F is signed by holding up your dominant hand, palm facing out, with your index finger and thumb touching, while your 3 other fingers are held up and spread apart. Make sure to form a circle with your thumb and index finger touching.</Text>
                        </View>
                    </View>
                    ...
                    <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter G is signed by holding out your dominant hand in a fist, with knuckles lined up vertically. Keep your middle, ring, and pinkie fingers curled in, while your index finger and thumb stick out parallel to each other.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter H is signed by holding out your dominant hand horizontally, palm facing in, with your index and middle fingers held out together, straight and stacked horizontally, index at the top. The rest of the fingers and thumb are curled in.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter I is signed by holding up your dominant hand in a fist, palm facing out, with only your pinkie finger sticking up straight.</Text>
                        </View>
                    </View>
                    ...
                    <View style = {styles.imagePlacement}>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter K is signed by holding up your dominant hand, palm facing out, with your index and middle fingers sticking up like the letter 'V' (or like the common "peace" sign), while your thumb is tucked at the base of the two extended fingers. Your two remaining fingers are curled in, touching your palm.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter L is signed by holding up your dominant hand, palm facing out, with your thumb and index finger sticking out at a right angle to each other, while the last 3 fingers are curled in.</Text>
                        </View>
                    </View>
                    ...
                    <View style = {styles.imagePlacement}>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter O is signed by curving all your fingers and touching them to your thumb, making the shape of the letter 'O' with your entire hand.</Text>
                        </View>
                    </View>
                    ...
                    <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter P is signed like K, but the former is held upside down. Hold down your dominant hand, palm facing in, with your index and middle fingers sticking out like an inverted letter 'V', while your thumb is tucked in between the two extended fingers. Your two remaining fingers are curled in, touching your palm.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter R is signed by holding up your dominant hand, palm facing out, with your index and middle fingers intertwined like vines. The rest of your fingers and thumb are curled in. This looks just like the small letter 'r'.</Text>
                        </View>
                    </View>
                    ...
                    <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter S is signed by holding up your dominant hand into a fist, palm facing out. Make sure your thumb is tucked in front of your fingers. Otherwise, you might sign the letter A by mistake.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter T is signed by holding up your dominant hand into a fist, palm facing out, and your thumb tucked in between your index and middle fingers.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter U is signed by holding up your dominant hand in a fist, facing outward, with the index and middle fingers sticking up while held together.</Text>
                        </View>
                    </View>
                    ...
                    <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter V is signed by holding up your dominant hand in a fist, facing outward, with the index and middle fingers sticking out and spread apart. It looks just like the letter 'V'.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter W is signed by holding up your dominant hand in a fist, palm facing out, with your index, middle, and ring fingers sticking out. This looks just like the letter 'W'</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter X is signed by holding up your dominant hand in a fist, palm facing out. Then stick out your index finger and bend it into a hook.</Text>
                        </View>
                    </View>
                    ...
                    <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter Y is signed by holding up your dominant hand, palm facing out, with your thumb and pinkie finger sticking out and the rest of your fingers curled in.</Text>
                        </View>
                        ...
                        <View style = {styles.imagePlacement}>
                            ...
                            <Text style = {styles.text}>The letter Z is signed by holding up the index finger of your dominant hand, palm facing out with the rest of the fingers drawn into a fist, and tracing the letter 'Z' with your index in the air.</Text>              
                        </View>
                    </View>
                </ScrollView>
            </View>
