    ...
    return(
        <ScrollView style={styles.scrollView}>
            ...
            <View>
                ...
                <View style = {styles.text}>
                <Text>The letter E is signed by holding up your dominant hand, palm facing out, with your top 4 fingers all touching each other and tightly curved in, while your thumb is also curved and tightly tucked into your palm, touching the tips of the fingers above. This looks just like the small letter 'e'.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter F is signed by holding up your dominant hand, palm facing out, with your index finger and thumb touching, while your 3 other fingers are held up and spread apart. Make sure to form a circle with your thumb and index finger touching.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter G is signed by holding out your dominant hand in a fist, with knuckles lined up vertically. Keep your middle, ring, and pinkie fingers curled in, while your index finger and thumb stick out parallel to each other.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter H is signed by holding out your dominant hand horizontally, palm facing in, with your index and middle fingers held out together, straight and stacked horizontally, index at the top. The rest of the fingers and thumb are curled in.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter I is signed by holding up your dominant hand in a fist, palm facing out, with only your pinkie finger sticking up straight.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter J is signed by holding up your dominant hand, palm facing out, with your fingers curled into a fist except your pinkie sticking out. Then make a 'J' in the air with your pinkie finger, starting from the top of the 'J' stem down and curving up again to form the bottom part of the letter.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
            ...
            <View>
                ...
                <View style = {styles.text}>
                <Text>The letter L is signed by holding up your dominant hand, palm facing out, with your thumb and index finger sticking out at a right angle to each other, while the last 3 fingers are curled in.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter M is signed by holding up your dominant hand, palm facing out, with all your fingers curled into your palm. Then tuck your thumb between your ring and pinkie fingers. This sign looks like the small letter 'm', with the 3 fingers' bumps reminding us of the letter written in cursive.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter N is signed by holding up your dominant hand, palm facing out, with all your fingers curled into your palm. Then tuck your thumb between your middle and ring fingers. This sign looks like the small letter 'n', with the 2 fingers' bumps reminding us of the letter written in cursive.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter O is signed by curving all your fingers and touching them to your thumb, making the shape of the letter 'O' with your entire hand.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
            ...
            <View>
                ...
                <View style = {styles.text}>
                <Text>The letter Q is signed by holding down your dominant hand, palm facing in, with your with knuckles lined up horizontally. Keep your middle, ring, and pinkie fingers curled in, while your index finger and thumb stick out parallel to each other, like two legs of a person standing up.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter R is signed by holding up your dominant hand, palm facing out, with your index and middle fingers intertwined like vines. The rest of your fingers and thumb are curled in. This looks just like the small letter 'r'.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter S is signed by holding up your dominant hand into a fist, palm facing out. Make sure your thumb is tucked in front of your fingers. Otherwise, you might sign the letter A by mistake.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter T is signed by holding up your dominant hand into a fist, palm facing out, and your thumb tucked in between your index and middle fingers.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter U is signed by holding up your dominant hand in a fist, facing outward, with the index and middle fingers sticking up while held together.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter V is signed by holding up your dominant hand in a fist, facing outward, with the index and middle fingers sticking out and spread apart. It looks just like the letter 'V'.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter W is signed by holding up your dominant hand in a fist, palm facing out, with your index, middle, and ring fingers sticking out. This looks just like the letter 'W'</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter X is signed by holding up your dominant hand in a fist, palm facing out. Then stick out your index finger and bend it into a hook.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter Y is signed by holding up your dominant hand, palm facing out, with your thumb and pinkie finger sticking out and the rest of your fingers curled in.</Text>
            </View>
            <View>
                <Image
                style = {styles.image}
                ...
                <View style = {styles.text}>
                <Text>The letter Z is signed by holding up the index finger of your dominant hand, palm facing out with the rest of the fingers drawn into a fist, and tracing the letter 'Z' with your index in the air.</Text>
            </View>
