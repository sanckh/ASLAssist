    ...
    return(
        <Background>
            ...
            <Image
                style = {styles.image}
                source = {{
                    uri: 'https://firebasestorage.googleapis.com/v0/b/aslassistfinal.appspot.com/o/LessonTwoQuizBlurredImages%2Fhalloween-blurred.gif?alt=media&token=d9ca3092-cac8-47da-af2f-fbdf7083d74b'
                }}>
                </Image>
                <View>
            ...
            <Button
            onPress={() => navigation.navigate('twoPageFour')}
            mode = "contained"
            style = {{backgroundColor: '#daeaf6', 
                ...
                marginRight: 40,
                marginLeft: 10}}>
                <Text color={theme.colors.text} textAlign='center'>Halloween</Text>
            </Button>
