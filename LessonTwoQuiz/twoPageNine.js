    ...
    return(
        <Background>
            ...
            <Image
                style = {styles.image}
                source = {{
                    uri: 'https://firebasestorage.googleapis.com/v0/b/aslassistfinal.appspot.com/o/LessonTwoQuizBlurredImages%2Fvalentinesday-blurred.gif?alt=media&token=04f42e8f-2927-4146-a3dd-1a7ac381d7dc'
                }}>
                </Image>
                <View>
            ...
            <Button
            onPress={()=> navigation.navigate('twoPageTen')}
            mode = "contained"
