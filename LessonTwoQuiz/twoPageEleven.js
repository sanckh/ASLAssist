    ...
    return(
        <Background>
            ...
            <Image
                style = {styles.image}
                source = {{
                    uri: 'https://firebasestorage.googleapis.com/v0/b/aslassistfinal.appspot.com/o/LessonTwoQuizBlurredImages%2Fthanksgiving-blurred.gif?alt=media&token=a4362a71-ea4a-46a6-9697-432b7b0f437f'
                }}>
                </Image>
                <View>
            ...
            <Button
            onPress={()=> navigation.navigate('twoPageTwelve')}
            mode = "contained"
            ...
            style = {{backgroundColor: '#daeaf6', 
                ...
                borderColor: '#0a2941',
                marginRight: 10,}}>
                <Text color={theme.colors.text} textAlign='center'>Help</Text>
            </Button>
