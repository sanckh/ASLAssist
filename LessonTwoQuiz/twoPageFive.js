    ...
    return(
        <Background>
            ...
            <Image
                style = {styles.image}
                source = {{
                    uri: 'https://firebasestorage.googleapis.com/v0/b/aslassistfinal.appspot.com/o/LessonTwoQuizBlurredImages%2Fpain-blurred.gif?alt=media&token=4b12d113-fd6f-479b-88b9-0385308402be'
                }}>
                </Image>
                <View>
            ...
            <Button
            onPress = {() => navigation.navigate('twoPageSix')}
            mode = "contained"
            style = {{backgroundColor: '#daeaf6', 
                width: 150,
                height: 60,
