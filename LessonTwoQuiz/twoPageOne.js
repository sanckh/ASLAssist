    ...
    return(
        <Background>
            ...
            <Image
                style = {styles.image}
                source = {{
                    uri: 'https://firebasestorage.googleapis.com/v0/b/aslassistfinal.appspot.com/o/LessonTwoQuizBlurredImages%2Fhappy-blurred.gif?alt=media&token=dff18d84-f7f9-420d-b88b-c15f792d2289'
                }}>
                </Image>
                <View>
            ...
            <Button
            onPress={()=> navigation.navigate('twoPageTwo')}
            mode = "contained"
