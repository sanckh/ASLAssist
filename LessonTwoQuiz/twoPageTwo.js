    ...
    return(
        <Background>
            ...
            <Image
                style = {styles.image}
                source = {{
                    uri: 'https://firebasestorage.googleapis.com/v0/b/aslassistfinal.appspot.com/o/LessonTwoQuizBlurredImages%2Fflagday-blurred.gif?alt=media&token=939ff955-060f-4133-aacf-854b518c7b93'
                }}>
                </Image>
                <View>
            ...
            <Button
            onPress={()=> navigation.navigate('twoPageThree')}
            mode = "contained"
            style = {{backgroundColor: '#daeaf6', 
                width: 150,
                height: 60,
                ...
                borderColor: '#0a2941',
                marginRight: 10,}}>
                <Text color={theme.colors.text} textAlign='center'>Flag Day</Text>
            </Button>
