    ...
    return(
        <Background>
            ...
            <Image
                style = {styles.image}
                source = {{
                    uri: 'https://firebasestorage.googleapis.com/v0/b/aslassistfinal.appspot.com/o/PracticeQuizOneBlurredImages%2Fsleepquiz.gif?alt=media&token=27a197a8-9b5e-4a76-8836-7c10cc07bd86'
                }}>
                </Image>
                <View>
            ...
            style = {{backgroundColor: '#daeaf6', 
                ...
                marginRight: 40,
                marginLeft: 10}}>
                <Text color={theme.colors.text} textAlign='center'>Depressed</Text>
            </Button>
            ...
            style = {{backgroundColor: '#daeaf6', 
                ...
                borderColor: '#0a2941',
                marginRight: 10,}}>
                <Text color={theme.colors.text} textAlign='center'>Calming</Text>
            </Button>
            </View>
            <View style={styles.screen}>
            <Button
            ...
            <Button
            onPress={()=> navigation.navigate('onePThirtyTh')}
            mode = "contained"
            style = {{backgroundColor: '#daeaf6', 
                width: 150,
                height: 60,
                ...
                borderColor: '#0a2941',
                marginRight: 10,}}>
                <Text color={theme.colors.text} textAlign='center'>Sleep</Text>
            </Button>
