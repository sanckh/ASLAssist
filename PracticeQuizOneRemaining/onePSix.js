    ...
    return(
        <Background>
            ...
            <Image
                style = {styles.image}
                source = {{
                    uri: 'https://firebasestorage.googleapis.com/v0/b/aslassistfinal.appspot.com/o/PracticeQuizOneBlurredImages%2Fballoonquiz.gif?alt=media&token=9fe92cad-f1c5-48f1-af32-21d433d800f1'
                }}>
                </Image>
                <View>
            ...
            <Button
            onPress = {() => navigation.navigate('onePSeven')}
            mode = "contained"
            style = {{backgroundColor: '#daeaf6', 
                width: 150,
                height: 60,
                ...
                borderColor: '#0a2941',
                marginRight: 10,}}>
                <Text color={theme.colors.text} textAlign='center'>Balloon</Text>
            </Button>
            </View>
            <View style={styles.screen}>
            <Button
