    ...
    return(
        <Background>
            ...
            <Image
                style = {styles.image}
                source = {{
                    uri: 'https://firebasestorage.googleapis.com/v0/b/aslassistfinal.appspot.com/o/PracticeQuizOneBlurredImages%2Fcarrotquiz.gif?alt=media&token=4695741b-636e-4ba2-9e0f-89df9144b696'
                }}>
                </Image>
                <View>
            ...
            <Button
            onPress={()=> navigation.navigate('onePTwentyO')}
            mode = "contained"
            ...
            style = {{backgroundColor: '#daeaf6', 
                ...
                borderColor: '#0a2941',
                marginRight: 10,}}>
                <Text color={theme.colors.text} textAlign='center'>Shave</Text>
            </Button>
            </View>
            <View style={styles.screen}>
            <Button
            ...
            style = {{backgroundColor: '#daeaf6', 
                ...
                borderColor: '#0a2941',
                marginRight: 10,}}>
                <Text color={theme.colors.text} textAlign='center'>Slice</Text>
            </Button>
