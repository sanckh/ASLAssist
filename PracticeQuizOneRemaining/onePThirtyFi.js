    ...
    return(
        <Background>
            ...
            <Image
                style = {styles.image}
                source = {{
                    uri: 'https://firebasestorage.googleapis.com/v0/b/aslassistfinal.appspot.com/o/PracticeQuizOneBlurredImages%2Fwaterquiz.gif?alt=media&token=82a89e0a-cde6-4030-bbef-2076629c7262'
                }}>
                </Image>
                <View>
            ...
            <Button
            onPress={()=> navigation.navigate('onePThirtySi')}
            mode = "contained"
            ...
            style = {{backgroundColor: '#daeaf6', 
                ...
                marginRight: 40,
                marginLeft: 10}}>
                <Text color={theme.colors.text} textAlign='center'>Thirsty</Text>
            </Button>
            ...
            style = {{backgroundColor: '#daeaf6', 
                ...
                borderColor: '#0a2941',
                marginRight: 10,}}>
                <Text color={theme.colors.text} textAlign='center'>Sweat</Text>
            </Button>
