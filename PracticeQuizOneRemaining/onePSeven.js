    ...
    return(
        <Background>
            ...
            <Image
                style = {styles.image}
                source = {{
                    uri: 'https://firebasestorage.googleapis.com/v0/b/aslassistfinal.appspot.com/o/PracticeQuizOneBlurredImages%2Fballquiz.gif?alt=media&token=a4c39384-6363-4530-86fd-700558b53bb4'
                }}>
                </Image>
                <View>
            ...
            <Button
            onPress={()=> navigation.navigate('onePEight')}
            mode = "contained"
            style = {{backgroundColor: '#daeaf6', 
                ...
                marginRight: 40,
                marginLeft: 10}}>
                <Text color={theme.colors.text} textAlign='center'>Ball</Text>
            </Button>
            ...
            style = {{backgroundColor: '#daeaf6', 
                ...
                borderColor: '#0a2941',
                marginRight: 10,}}>
                <Text color={theme.colors.text} textAlign='center'>Round</Text>
            </Button>
            </View>
            <View style={styles.screen}>
            <Button
            ...
            style = {{backgroundColor: '#daeaf6', 
                ...
                marginRight: 40,
                marginLeft: 10}}>
                <Text color={theme.colors.text} textAlign='center'>Circle</Text>
            </Button>
