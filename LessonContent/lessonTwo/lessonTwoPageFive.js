...
export default function LessonTwo({navigation}){
    ...
    return(
        <Background>
            ...
            <Button
            mode = "contained"
            onPress = {() => navigation.navigate('lessonTwoPageSix')}
            ...
            <View>
                <ProgressBar style = {{width: 200, marginTop: 15}} progress={0.25} color={"lightgreen"}/>
                    <Text style={{alignSelf:"center",position:"absolute"}}>25%</Text>
            </View>
