...
export default function LessonTwo({navigation}){
    ...
    return(
        <Background>
            <TouchableOpacity  onPress = { () => navigation.replace('LessonOnePageNine')} style={styles.iconContainer}>
            ...
            <View style = {{flexDirection: 'row', marginTop: 10}}>
                <View style = {styles.imagePlacement}>
                    ...
                    style = {styles.image}
                    source = {{
                        uri: 'https://firebasestorage.googleapis.com/v0/b/aslassistfinal.appspot.com/o/LessonOne%2Fcolor.gif?alt=media&token=913937ce-c8a1-43d9-bd39-57b96163040c'
                    }}>
                    </Image>
                    <Text>To do the sign for "color" hold your hand up in front of your neck and chin area then flutter the fingertips.</Text>
                </View>
