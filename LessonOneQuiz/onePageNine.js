    ...
    return(
        <Background>
            ...
            <Image
                style = {styles.image}
                source = {{
                    uri: 'https://firebasestorage.googleapis.com/v0/b/aslassistfinal.appspot.com/o/LessonOneQuizBlurredImages%2Fwhite-cropped.gif?alt=media&token=bdbfa739-121d-4b84-a2ec-940fef45834f'
                }}>
                </Image>
                <View>
            ...
            <Button
            onPress={()=> navigation.navigate('onePageTen')}
            mode = "contained"
            ...
            style = {{backgroundColor: '#daeaf6', 
                ...
                borderColor: '#0a2941',
                marginRight: 10,}}>
                <Text color={theme.colors.text} textAlign='center'>Pink</Text>
            </Button>
            </View>
            <View style={styles.screen}>
            <Button
            ...
            style = {{backgroundColor: '#daeaf6', 
                ...
                marginRight: 40,
                marginLeft: 10}}>
                <Text color={theme.colors.text} textAlign='center'>Purple</Text>
            </Button>
