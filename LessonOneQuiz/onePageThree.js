    ...
    return(
        <Background>
            ...
            <Image
                style = {styles.image}
                source = {{
                    uri: 'https://firebasestorage.googleapis.com/v0/b/aslassistfinal.appspot.com/o/LessonOneQuizBlurredImages%2Fred-cropped.gif?alt=media&token=919720c5-b598-4d96-a4ad-5eda8b829880'
                }}>
                </Image>
                <View>
            ...
            <Button
            onPress={() => navigation.navigate('onePageFour')}
            mode = "contained"
            ...
            style = {{backgroundColor: '#daeaf6', 
                ...
                marginRight: 40,
                marginLeft: 10}}>
                <Text color={theme.colors.text} textAlign='center'>Orange</Text>
            </Button>
