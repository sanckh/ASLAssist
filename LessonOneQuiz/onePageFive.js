    ...
    return(
        <Background>
            ...
            <Image
                style = {styles.image}
                source = {{
                    uri: 'https://firebasestorage.googleapis.com/v0/b/aslassistfinal.appspot.com/o/LessonOneQuizBlurredImages%2Fblue-cropped.gif?alt=media&token=b84c2afe-de53-492d-908b-bc6da499a7c3'
                }}>
                </Image>
            ...
            <View style={styles.screen}>
            <Button
            onPress={()=> navigation.navigate('onePageSix')}
            mode = "contained"
            style = {{backgroundColor: '#daeaf6', 
                width: 150,
                height: 60,
