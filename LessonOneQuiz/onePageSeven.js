    ...
    return(
        <Background>
            ...
            <Image
                style = {styles.image}
                source = {{
                    uri: 'https://firebasestorage.googleapis.com/v0/b/aslassistfinal.appspot.com/o/LessonOneQuizBlurredImages%2Felephant-blurred.gif?alt=media&token=c64e2601-16a1-471c-86f7-7aeed2da3bc2'
                }}>
                </Image>
                <View>
            ...
            <Button
            onPress={()=> navigation.navigate('onePageEight')}
            mode = "contained"
            style = {{backgroundColor: '#daeaf6', 
                width: 150,
                height: 60,
